...
def test_dummy_cal(dummy_cal, dummy_data) -> None:
...
def test_dummy_cal_df(dummy_cal, dummy_data) -> None:
...
def test_ka_ba_ra(dummy_cal, dummy_data) -> None:
    dummy_cal.K_a *= 2
    dummy_cal.b_a += 2
...
def test_kg_rg_bg(dummy_cal, dummy_data) -> None:
    dummy_cal.K_g *= 2
    dummy_cal.b_g += 2
...
def test_kga(dummy_cal, dummy_data) -> None:
    dummy_cal.K_g *= 2
    dummy_cal.b_g += 2
    dummy_cal.R_g = np.array([[0, 0, 1], [0, 1, 0], [0.5, 0, 0]])
